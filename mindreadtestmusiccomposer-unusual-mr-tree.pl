% swipl --goal=main_mc --stand_alone=true -o mc -c mindreadtestmusiccomposer-unusual-4-mr-tree.pl
main_mc :- sectest0(Form1,Lyrics,Melody,Harmony,MelodyParts,HarmonyParts,Vocalstubinstrument,Song1),!.
...
instrumentlist(NumberofInstruments1,Instruments1,Instruments2) :-
	...
	mind_read(Instrument,Instruments),
